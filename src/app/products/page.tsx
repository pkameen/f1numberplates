...
const Gallery = () => {
  ...
  return (
    <section
      id="gallery"
      className="pb-0 relative overflow-hidden bg-[#050505] py-24"
    >
      < Navbar />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="mb-14 mt-5 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <div className="mt-12 flex flex-col items-center justify-center">
          ...
          <p className="mt-6 mb-6 text-center text-sm tracking-[0.25em] text-zinc-500 uppercase">
